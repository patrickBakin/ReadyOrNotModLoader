...
void UVictoryBPFunctionLibrary::VictoryCreateProc(int32& ProcessId, const FString& FullPathOfProgramToRun, TArray<FString> CommandlineArgs, bool Detach, bool Hidden, int32 Priority, const FString& OptionalWorkingDirectory) {
}
...
void UVictoryBPFunctionLibrary::GetUTCFromUnixTimeStamp(int32 UnixTimeStamp, FDateTime& UTCTime) {
}
...
int32 UVictoryBPFunctionLibrary::GetUnixTimeStamp(const FDateTime& UTCTime) {
    return 0;
}
...
bool UVictoryBPFunctionLibrary::FileIO__SaveStringTextToFile(const FString& SaveDirectory, const FString& JoyfulFileName, const FString& SaveText, bool AllowOverWriting) {
    return false;
}

bool UVictoryBPFunctionLibrary::FileIO__SaveStringArrayToFile(const FString& SaveDirectory, const FString& JoyfulFileName, TArray<FString> SaveText, bool AllowOverWriting) {
    return false;
}
