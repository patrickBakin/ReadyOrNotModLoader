...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void VictoryCreateProc(int32& ProcessId, const FString& FullPathOfProgramToRun, TArray<FString> CommandlineArgs, bool Detach, bool Hidden, int32 Priority, const FString& OptionalWorkingDirectory);
    ...
    UFUNCTION(BlueprintCallable)
    static bool FileIO__SaveStringTextToFile(const FString& SaveDirectory, const FString& JoyfulFileName, const FString& SaveText, bool AllowOverWriting);
    
    UFUNCTION(BlueprintCallable)
    static bool FileIO__SaveStringArrayToFile(const FString& SaveDirectory, const FString& JoyfulFileName, TArray<FString> SaveText, bool AllowOverWriting);
